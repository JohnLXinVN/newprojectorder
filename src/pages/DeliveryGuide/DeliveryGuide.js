...
import styles from './DeliveryGuide.module.scss';
...
const DeliveryGuide = () => {
    return (
        <div className={cx('wrapper')}>
            <Direction title="Delivery Guide" />
            <div className="container">
                ...
                <div className={cx('wrap-guide')}>
                    ...
                    <p>
                        <strong>Bước 2:</strong> Click và sản phẩm muốn mua, màn hình hiển
                    ...
                    <p>
                        Nếu bạn muốn mua hàng mà không cần tài khoản vui lòng nhấp chuột
